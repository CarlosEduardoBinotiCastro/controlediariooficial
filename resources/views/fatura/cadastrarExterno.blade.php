...
<div class="container" id="body">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header"> {{ __('Cadastrar Fatura Externa') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form id='form' method="POST" action="{{ url("/fatura/formatarExterno") }}" enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="centimetragem" class="col-md-4 col-form-label text-md-right">{{ __('Centimetragem') }} <span style="color:red;">*</span></label>

                            <div class="col-md-6">
                                <input id="centimetragem" type="number" class="form-control{{ $errors->has('centimetragem') ? ' is-invalid' : '' }} inputNumber" name="centimetragem" placeholder="Digite a centimetragem" value="{{old('centimetragem')}}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="valorTotal" class="col-md-4 col-form-label text-md-right">{{ __('Valor Total (R$)') }} <span style="color:red;">*</span></label>

                            <div class="col-md-6">
                                <input id="valorTotal" type="number" class="form-control{{ $errors->has('valorTotal') ? ' is-invalid' : '' }} inputNumber" name="valorTotal" placeholder="Digite o valor total" value="{{old('valorTotal')}}" required>
                            </div>
                        </div>
                        ...
                        <div class=" row col-md-8 offset-md-2">
                            ...
                            <div class="col-md-8">
                                ...
                                <strong><sub style="font-size:90%;">Somente arquivos na extensão 'PDF ou DOCX'. <br>
                            ...
                            <div class="col-md-4" id="divBotao">
                                <br>
                                <input id="btnEnviar" type="submit" class="btn btn-success" value="Enviar Fatura Externa">
                            </div>
