...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"> {{ __('Cadastrar Caderno') }}</div>
                ...
                <div class="card-body">
                    <form id='form' method="POST" action="{{ url("/caderno/salvar") }}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cadernoNome" type="text" class="form-control{{ $errors->has('cadernoNome') ? ' is-invalid' : '' }}" name="cadernoNome" value="{{ old('cadernoNome') }}" placeholder="nome do caderno" required autofocus>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function($) {
        ...
        var documentosList = [];
        // var documentosSelect = <?php  echo $documentos ?> ;
